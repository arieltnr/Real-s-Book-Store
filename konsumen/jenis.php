...
$brg = $conn -> query("select * from buku JOIN jenis USING(id_jenis) WHERE nama_jenis = '$jenis' limit $start, $per_hal");
                    ...
                    <li class="dropdown active">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Kategori
                          ...
                          <ul class="dropdown-menu"><?php while($da = $j -> fetch_array()){ ?>
                              <li <?php if($da[1]==$jenis){ ?> class='active' <?php } ?>>
            ...
            <div class="col-lg-12">
                <table class="table">
                    <tr bgcolor="teal">
                        ...
                        <th>
                            <font color="white" size="2"> <b>Jenis Buku : <?php echo $jenis; ?> </b></font>
                        </th>
                         ...
                         <div class="oo">
                                       <?php echo "<img style='solid #333333; border-radius:5px;
                                        ...
                                        <a class="btn" data-toggle="tooltip" data-placement="top" 
                                         ...
                                         href="detail.php?no=<?php echo $data['noisbn']; ?>">
        ...
        <div class="col-md-3" style="margin-top: 10px;">
            <div class="list-group">
                ...
                <div class="buters-guide">
                  <img class="img5" src="../icon/icon.png" width="260">
                    <font size="3" color="grey" face="impact">
                         <p><span>Membawa ilmu itu tidak berat.</span>  
                                  Ringan, bisa dibawa kemana-mana. 
                        </p>
                    </font>
...
if(isset($_POST['signu'])){
    ...
    $move = move_uploaded_file($_FILES['firstname1']['tmp_name'], 'admin/img/pembeli/'.$gambar);
    
$conn -> query("INSERT INTO pembeli VALUES('$kode_otomatis', '$b', '$gambar', '$c', '$d', '$e', '$f', '$g', '$now')");
