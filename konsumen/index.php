...
$brg = $conn -> query("select * from buku WHERE stok >= 1 limit $start, $per_hal");
      ...
      <!-- /.col-->
          <div class="col-md-3" style="margin-top: 10px;">
                <div class="list-group">
                    <a href="index.php" class="list-group-item active"><span class="glyphicon glyphicon-home"></span> Beranda</a>
