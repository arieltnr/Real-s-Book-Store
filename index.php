...
$brg = $conn -> query("select * from buku limit $start, $per_hal");
?>
            ...
            <div class="col-lg-9">
              ...
              <div class="col-md-3">
                ...
                <div class="buters-guide">
                         ...
                         <p>
                         		  <span>Buku Adalah Jembatan Ilmu.</span>	
				                  Barang siapa yg mencari ilmu, niscaya hidupnya terjamin. 
                        </p>
                    		</font>
                     <a class="btn btn-info btn-lg"> More Info</a>
               </div>
                </fieldset>
                <br><br>
                 <p class="lead">Follow US</p><hr>
                <div class="navbar nav">
                    <a target="_blank" href="https://www.facebook.com/profile.php?id=100008460228219"><img src="icon/1.jpg" width="70" height="50" style="margin: 2px;"></a>
                    <a target="_blank" href="https://twitter.com/Rrealgood_"><img src="icon/2.jpg" width="70" height="50" style="margin: 2px;"></a>
                    <a target="_blank" href=""><img src="icon/3.jpg" width="70" height="50" style="margin: 2px;"></a>
                    <a target="_blank" href="https://real.goood11@gmail.com"><img src="icon/4.jpg" width="70" height="50" style="margin: 2px;"></a>
                    <a target="_blank" href="https://www.instagram.com/Rrealgood"><img src="icon/5.jpg" width="70" height="50" style="margin: 2px;"></a>
                    <a target="_blank" href=""><img src="icon/6.jpg" width="70" height="50" style="margin: 2px;"></a>
                </div>
            </div>
		</div>
          </center>  
...
<center>
			...
			for($x=1;$x<=$halaman;$x++){
				...
				<a class="btn btn-warning" href="?page=<?php echo $x ?>">
                    <?php echo $x ?></a>
				<?php
			}
			?>
