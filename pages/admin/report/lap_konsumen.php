...
$pdf->Cell(25.5,0.7,"Laporan Data Konsumen",0,10,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
while($lihat = mysqli_fetch_array($query)){
	...
	$pdf->Cell(5, 0.8, $lihat['tgl_daftar'],1, 1, 'C');
