...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><font face="impact" size="6">Selamat Datang <?php echo $f[1]; ?></font></h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Aplikasi Toko Buku Online</div>
                      <div class="container">
					    <div class="panel-body">
                              <table>
                                  <tr align="center">
                                      <td>
                                         <img class="img" src="../../icon/icon.png" width="75%" height="300">
                                      </td>
                                      <td>
                                         <img style="margin-left: 23px;" class="img" src="../../icon/book.png" width="75%" height="300">
                                      </td>
                                      <td>
                                          <img class="img" src="../../icon/lezen.png" width="75%" height="300">
                                      </td>
                                  </tr>
                              </table>
						</div>
