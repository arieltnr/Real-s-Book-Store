...
include'../../conf.php';
ob_start();
$carikode = $conn -> query("SELECT max(id_penerbit) FROM penerbit");
  ...
  if ($datakode) {
   ...
   $kode = $kode + 1;
   $kode_otomatis = "PT".str_pad($kode, 2, "0", STR_PAD_LEFT);
  } else {
   $kode_otomatis = "PT01";
  }
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
                         ...
                         <a class="btn btn-info" target="_blank" href="report/lap_penerbit.php">
                            <span class="glyphicon glyphicon-print"></span> Cetak Laporan
                         </a>
                         <a class="btn btn-default" href="distributor.php"><span class="glyphicon glyphicon-refresh"></span> Refresh</a>
                    </div>
                      <div class="container">
					...
					<div class="panel-body">
                         <table id="lookup" class="table table-striped" data-toggle="table" data-select-item-name="toolbar1">
                            ...
                            <tr>
                                ...
                                <td> <a class="btn btn-info" href="distributorde.php?id=<?php echo $data[0]; ?>"><span class="glyphicon glyphicon-list"></span></a>
                                     <a class="btn btn-warning" href="distributored.php?id=<?php echo $data[0]; ?>"><span class="glyphicon glyphicon-edit"></span></a>
                                     <a class="btn btn-danger" href="distributorha.php?id=<?php echo $data[0]; ?>"><span class="glyphicon glyphicon-remove" onclick="return confirm('Hapus???')"></span></a>
                                </td>
                            </tr>
                            <?php } ?>
                                 </tbody>
			...
			<div class="modal-content">
              ...
              <form action="" method="POST" class="form-horizontal">
				<div class="modal-body">
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="nama">ID Distribuor:</label>
                       <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="nama">Nama Distributor:</label>
                      <div class="col-sm-7">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="nama">Telp:</label>
                       <div class="col-sm-4">
                       <input type="number" class="form-control" name="d" min="999999999" max="999999999999999" required="">
                       </div>
                     </div>
				</div>
...
$up = $conn -> query("INSERT INTO penerbit VALUES('$a', '$b', '$c', '$d')");
    if($up) { ?>
         <script language="JavaScript">
	              alert('Data Berhasil Ditambahkan');
	              document.location='distributor.php';
	     </script>
<?php }
