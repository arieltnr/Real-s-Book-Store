...
include'../../conf.php';
$id = $_GET['id'];
$sqll = $conn -> query("SELECT * FROM pembeli WHERE idpem = '$id'");
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Real's Book</div>
                      <div class="container">
                         <a href="guest.php"><span class="glyphicon glyphicon-arrow-left"></span></a>
                      </div>
					<div class="panel-body">
                        <table class="table table-striped">
                            ...
                            <tr>
						        <th> Foto </th>
                                <td> <img src="../admin/img/pembeli/<?php echo $data[2]; ?>" width='198px' height='300px'/> </td>
                            </tr>
                            <?php } ?>
                        </table>
						</div>
